...
- [ ] Persist checkpoint pointer metadata through the Phase 4 analysis-run/agent-report storage path. The Phase 4 migration now provides `agent_checkpoint_pointers`, but the runner still needs to write rows there.
